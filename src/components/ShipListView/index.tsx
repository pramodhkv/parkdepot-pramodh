  ...
  return (
    ...
    >
      <div className="flex py-4 px-8">
        <div className="image-wrapper w-24 h-24 relative overflow-hidden">
          <img
        ...
        <div className="flex-1 mx-8 flex flex-col justify-center">
          ...
          <h3 className="text-lg text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 font-bold mt-1">
            {ship.name}
          </h3>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <h3 className="text-lg text-white font-bold mt-1">{ship.type}</h3>
        </div>
