...
const Dropdown = (props: IDropdownProps) => {
  ...
  return (
    <Menu as="div" className="w-full relative">
      <Menu.Button className="inline-flex w-full min-h-[3rem] justify-center rounded-md bg-body-400 p-3 text-white font-bold text-sm md:text-lg ">
        {selectedMenu}
        <FiChevronDown className="ml-2 mt-1" aria-hidden="true" />
      </Menu.Button>

      <Menu.Items className="absolute mt-3 w-56 rounded-lg bg-body-400 z-10 backdrop-blur-2xl text-sm md:text-lg text-white font-bold">
